...
package ch.kostceco.tools.kostconverter.exception;
...
public class KOSTConverterException extends Exception
{

	private static final long	serialVersionUID	= -8666753675661449719L;

	public KOSTConverterException()
	{
		super();
	}

	public KOSTConverterException( String message )
	{
		super( message );
	}
